...
class PersonalAccessToken extends Model
{
    ...
    protected $validationMessages = [
        ...
        'tokenable_id' => [
            'required' => 'معرف الكائن مطلوب',
            'integer'  => 'معرف الكائن يجب أن يكون رقم',
        ],
        'name' => [
            'required' => 'اسم التوكن مطلوب',
        ],
        'token' => [
            'required'  => 'التوكن مطلوب',
            'is_unique' => 'التوكن موجود مسبقاً',
        ],
    ];
    ...
    {
        return $this->where('tokenable_type', 'App\\Models\\User')
